...
const CompletedAppointmentList: React.FC = () => {
    ...
    const formatDate = (date: string) => {
        ...
        const day = d.getDate().toString().padStart(2, '0'); // Pad single digits with leading 0
        const month = (d.getMonth() + 1).toString().padStart(2, '0'); // Get month (0-based, so add 1)
                        ...
                        <tbody>
                            {data.map((patient: any) => (
                                <tr key={patient.uuid}>
                                    ...
                                    <td>
                                        {patient.referedtoUser.firstname} {patient.referedtoUser.lastname}<br />
                                    </td>
